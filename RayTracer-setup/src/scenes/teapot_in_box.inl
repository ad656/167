...
Scene* teapot_in_box() {
    ...
    std::shared_ptr<GlossyMaterial> new_material = std::make_shared<GlossyMaterial>(vec3(0.5f, 0.5f, 1.0f), vec3(0.25f), 0.5f);
    std::shared_ptr<GlossyMaterial> glossy_material = std::make_shared<GlossyMaterial>(vec3(0.1f, 0.1f, 0.3f), vec3(0.9f), 0.9f);
    ...
    bottom_square->model = std::make_unique<Square>(vec3(0.0f, 0.0f, 0.0f), 4.0f, vec3(0.0f, 1.0f, 0.0f), diffuse_material_red_wall);
    ...
    right_square->model = std::make_unique<Square>(vec3(0.0f, 0.0f, 0.0f), 4.0f, vec3(-1.0f, 0.0f, 0.0f), diffuse_material_white_wall);
    ...
    left_square->model = std::make_unique<Square>(vec3(0.0f, 0.0f, 0.0f), 4.0f, vec3(1.0f, 0.0f, 0.0f), diffuse_material_white_wall);
    root_node->childnodes.push_back(std::move(left_square));
    root_node->childtransforms.push_back(translate(mat4(1.0f), vec3(-2.0f, 0.0f, 0.0f)));

    std::unique_ptr<Node> up_square = std::make_unique<Node>();
    up_square->model = std::make_unique<Square>(vec3(0.0f, 0.0f, 0.0f), 4.0f, vec3(0.0f, -1.0f, 0.0f), diffuse_material_green_wall);
    root_node->childnodes.push_back(std::move(up_square));
    root_node->childtransforms.push_back(translate(mat4(1.0f), vec3(0.0f, 2.0f, 0.0f)));

    std::unique_ptr<Node> back_square = std::make_unique<Node>();
    back_square->model = std::make_unique<Square>(vec3(0.0f, 0.0f, 0.0f), 4.0f, vec3(0.0f, 0.0f, 1.0f), glossy_material);
    ...
    bunny->model = std::make_unique<Obj>("../models/bunny.obj", new_material);
    root_node->childnodes.push_back(std::move(bunny));
    root_node->childtransforms.push_back(
        translate(vec3(0.0f, -0.7f, 0.0f)) *
        scale(vec3(1.2f, 1.2f, 1.2f)) *
        rotate(degree_to_rad(180.0f), vec3(0.f, 1.25f, 0.0f)));
